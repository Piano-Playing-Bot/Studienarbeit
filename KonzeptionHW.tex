...
handelt). \newline
//TODO: kleines Intro Arduino:
Es handelt sich dabei um eine Plattform für die Entwicklung von elektronischen Prototypen. Er besteht aus
...
Der Arduino bietet eine benutzerfreundliche Plattform für die Entwicklung und Implementierung
...
//TODO: kleines Intro Rasperry: \newline
//TODO: Entscheidung: Vor- und Nachteile Rasperry und Arduino, insbesondere das entscheidung darauf basiert, dass Arduino vor allem
für wiederholt ausgeführte Aufgaben besonders gut geeignet ist und ein Rasperry zwar durch Ports etc. mehr Möglichkeiten
bietet, wir diese aber für die Studienarbeitnicht wirklich brauchen. \newline
Für das Projekt wird spezifisch ein Arduino R3 verwendet.
Er bietet er PWM (Pulsweitenmodulation) Pins, die im Rahmen des Projekts genutzt wurden.
//TODO: Speicher
...
zu erreichen. //TODO Add piture pulsweite \newline
