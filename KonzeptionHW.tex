...
eine Stromversorgung von etwa 0.4 Amper, für 10 Aktuatoren sind das also 4 Amper. Das Netzteil welches wir verwenden, ist auf
6(?) Amper ausgelegt, wobei wir mit einem Netzteil getestet haben, welches 2,8 Amper unterstützt. Es gibt Netzteile die
...
wir bei einem Netzteil mit einem maximalen Stromfluss von 6 Amper (und 24V Leistung) verblieben sind.
