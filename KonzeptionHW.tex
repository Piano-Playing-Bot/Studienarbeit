...
%Arduino Intro
	...
	Der Arduino verfügt über digitale und analoge Ein- und Ausgangspins, die für die Interaktion mit Geräten verwendet werden können \cite*[vgl.][]{.ArduinoVsRaspberry.22}.
	\begin{figure}[htbp]
		\centering
		\includegraphics [width=8cm] {img/ArduinoR3}
		\caption{Arduino Uno \cite[siehe]{fir.Arduino.24}}
		\label{img:Arduino}
	\end{figure}
\newline
%Pi Intro

\paragraph{Rasperry Pi[\cite*[siehe: ]{.ArduinoVsRaspberry.22}]}
...
\begin{figure}[htbp]
	...
	\caption{Rasperry Pi \cite[siehe]{okd.RasperryPi.24}}
	\label{img:Raspi}
\end{figure}
\newline
