...
Das hier besprochene zu lösende Problem ist das präzise Anschlagen der Klaviersaiten, basierend auf einer Eingabe des Nutzers.
Dafür wird in diesem Kapitel zunächst ein passendes Klavier (siehe Kapitel \ref{subsec:auswahl-des-klaviers}) gesucht und später so präpariert,
dass es über eine Verbindung zwischen der Saiten und der Aktuatoren (siehe Kapitel \ref{subsec:VerbindungTastenAktuatoren}) angespielt werden kann.
Wie die Elektronik für die Signalweitergabe zwischen Computer und Klavier funktioniert wird in Kapitel \ref{subsec:konzeptionhw-ansteuerungskonzept} und \ref{subsec:aktuator} erläutert.

\section{Mechanik} \label{sec:konzeptionhw-mechanik}

\subsection{Auswahl des Klaviers}\label{subsec:auswahl-des-klaviers}
