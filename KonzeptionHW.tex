...
\begin{enumerate}
	...
	% @Question(Jay): Ist es sinnvoll noch Vorteile zu nennen? Also sowas wie bessere Dynamik des Motors wodurch die Tasten "schöner" gespielt werden könnten und höhere Präzision was sinnvoll gewesen wäre wenn wir das von hinten hochdrücken gemacht hätten?
	% @Answer(Val): Würde ich nicht sagen
	...
	% @TODO(Val): Können wir auf das Datasheet der Hubmagnete verweisen oder so?
\end{enumerate}
...
% @TODO(Val): Wäre es nicht besser das Ergebnis erst am Ende des Unterkapitels zu zeigen?
...
Bei Hubmagneten ist es in der Regel egal, welcher Anschluss an Plus und welcher an Minus angeschlossen wird (siehe Kapitel \ref{subsec:aktuator}). % @TODO(Val): Wird das in dem Unterkapitel wirklich erklärt? Wäre es nicht besser, sich einfach direkt auf die Quelle hier zu referenzieren?
