...
An sich geht es hierbei darum, dass die tieferen Tasten mehr Kraftaufwand zum spielen erfordern als die der Hohen Töne.
...
\begin{minipage}{0.55\textwidth}
	\begin{enumerate}
		...
		% @Note(Val): Selbe Bezeichnung wie oben verwenden. Entweder LOW/HIGH oder AN/AUS
