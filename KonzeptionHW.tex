...
Datenbits verwendet wird \cite[vgl.][]{Schieberegister}.\newline
...
In dieser Arbeit wird spezifisch ein 74HC959 Schieberegister betrachtet \cite[siehe][für die Spezifikation]{dio.74HC595.18}.
Dieses hat folgenden Aufbau:
\begin{figure}[htbp]
\begin{minipage}{0.45\textwidth}
		\includegraphics [width=1\textwidth] {img/Schieberegister}
		\caption{Schematik Schieberegister}
		\source{\cite{dio.74HC595.18}}
		\label{img:Shift}
\end{minipage}
...
\begin{figure}[htbp]
	...
	\caption{Matrix mit Multiplexing}
	\source{\cite{fsa+.LEDMatrix.23}}
...
(den sogenannten Source und Drain) mithilfe eines dritten Anschlusses (der Gate) zu steuern \cite[vgl.]{sch.BipolarerTransistor.24}.
...
\begin{figure}[htbp]
	...
	\caption{Aufbau eines Rotors}
	\source{\cite{Aufbau.Elektromotoren}}
...
\begin{figure}[htbp]
	...
	\caption{Linearer Servomotor}
	\source{\cite{rei.ReicheltLinearerServomotor.24}}
...
\begin{figure}[htbp]
	...
	\caption{Aufbau eines Linearen Servomotors}
	\source{\cite{Linearer.Servo}}
...
\begin{figure}[htbp]
	...
	\caption{Hubmagnet Aufbau}
	\source{\cite{SolenoidDesign}}
...
\begin{enumerate}
	...
	\item \textbf{Hubmagnete:} Hubmagnete\footnote{siehe \cite{DatasheetSolenoids} für genauere Informationen} bieten Vorteile wie eine schnelle Reaktionsgeschwindigkeit, einfache Steuerung und geringen Kosten im Vergleich zu den anderen Aktuatoren. Die verwendeten Hubmagnete können eine Kraft von 25N ausüben,
...
Bei Hubmagneten ist es in der Regel egal, welcher Anschluss an Plus und welcher an Minus angeschlossen wird \cite[vgl.][]{SolenoidDesign}.
