...
Im weiteren Verlauf dieser Arbeit wird nicht weiter auf die Priorisierung eingegangen, da alle genannten auch umgesetzt wurden. % @TODO(Val): Ich würde vielleicht noch ein paar Anforderungen mit "niedrig" einbringen, damit auch Erweiterungsmöglichkeiten hier schon genannt werden. Dann muss dieser Satz angepasst werden
