...
Da es wünschenswert ist, dass Nutzer auf eine breite Palette fertiger Stücke zugreifen können und diesen einfach, selbstständig erweitern sollen,
...
\begin{table}[ht]
    ...
    \begin{tabular}{ | m{1cm} | m{2cm} | m{8cm} | m{2cm} | }
        ...
        \hline
        1 & \multirow {Allgemein} & Flexibilität: Das Klavier muss sowohl manuell als auch automatisch bespielbar sein. & Hoch \\
        \cline{1-1} \cline{3-4}
        ...
        \hline
        4 & \multirow {Hardware} & Tastenbetätigung: Hardware muss in der Lage sein, Klaviertasten autonom zu bedienen. & Hoch \\
        \cline{1-1} \cline{3-4}
        5 & & Anpassbarkeit: Hardware-Komponenten müssen auf unterschiedliche Klaviertypen anpassbar sein. & Mittel \\
        \hline
        6 & \multirow {Software} & Musikstück-Auswahl: Nutzer:innen wählen Musikstücke über eine Desktop-Anwendung. & Hoch \\
        \cline{1-1} \cline{3-4}
