...
% @Answer(Jay): Hab die Aufwandschätzung hinzugefügt, aber sonst wüsste ich nichts mehr
...
% @Note(Val): Was wird mit "Mechanik-Gewicht" gemeint? Vorher wird nie erwähnt, dass manche Tasten ein höheres Gewicht haben. Das wäre vielleicht wichtig vorher schon zu erwähnen
% @Note(Jay): Habs in Ansteuerungskonzept (Der letzte Absatz über Elektronik) hinzugefügt wenn das passt?
...
% @Note(Val): Erneut - warum wird erst jetzt erwähnt, dass sich die Tasten so stark unterscheiden? Wäre das bei der Konzeption oder dem Anbringen der Aktuatoren an das Piano nicht interessant zu wissen?
