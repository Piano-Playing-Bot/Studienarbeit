...
\begin{table}[htbp]
    ...
    \begin{tabular}{|m{4cm}|m{8cm}|}
        ...
        8 reduziert wurde\\ % @Note(Val): Bei der Umsetzung wird gerade noch gesagt, dass der Prototyp nur 8 Tasten anspielen kann. Dieser Wert (ob 8 oder 40 oder sonst was) muss einheitlich in der Arbeit sein
        \hline
