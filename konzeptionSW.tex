...
% @TODO(Val): Notwendigkeit eines abstrakt-definierten PlayedKeys

% @TODO(Val): Aufbau der Music-Nachricht (bzw. kurze Erklärung \& Spec in Anhang?)

% @TODO(Val): Erklären wie eine Music-Nachricht aussieht, wenn Musikstück fertig ist

% @TODO(Val): Limitation: Es wurde nicht getestet, um Flash-Speicher (der oftmals ausreichend groß ist) zum Speichern eines gesamten Songs ausgereicht hätte und welche Performanz-Probleme das mit sich gebracht hätte. Dann wäre Streaming unnötig. Wurde aber nicht getestet, ob das überhaupt eine viable Alternative wäre
