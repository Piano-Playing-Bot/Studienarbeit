...
Sobald dieser Interrupt ausgeführt wird, können die Signale, die zu den Hubmagneten gesendet werden, verändert werden. % @Note(Val): Der Satz klingt irgendwie komisch
