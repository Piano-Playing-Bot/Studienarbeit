...
\input{einleitung}   \acresetall % Reset acronym definitions each chapter
\input{Zielstellung} \acresetall
\input{KonzeptionHW} \acresetall
\input{umsetzungHW}  \acresetall
\input{ergebnisseHW} \acresetall
\input{konzeptionSW} \acresetall
\input{umsetzungSW}  \acresetall
\input{ergebnisseSW} \acresetall
\input{tests}        \acresetall
\input{fazit}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
