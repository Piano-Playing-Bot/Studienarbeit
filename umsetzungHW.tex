...
\begin{table}[htbp]
    ...
    \begin{tabular}{|m{3.8cm}|m{1.7cm}|m{8cm}|}
        ...
        \hline
        Kabel & $9\cdot40$ & Verbindungen \\ % @Note(Val): Warum 9*40? Das ist nicht offensichtlich und muss erklärt werden
        \hline
        LEDs & 90 & Tests \\ % @Note(Val): Warum 90? Würden 88 nicht ausreichen? Dass die dann im Pack von 90 gekauft werden müsssen ergibt sich, aber die extra 2 sind ja eig nicht benötigt oder? Selbe Note für die anderen 90er hier
        \hline
        1kOhm Widerstände & 90 & Sicherheit and shit \\
        \hline
        MOSFET & 90 & Steuerung Strom \\
        \hline
        Angelschnur & ...m & Verbindung Hubmagnet und Taste \\ % @Note(Val): Warum m? Brauchen wir nicht eine Angelschnur pro Taste? Also 88 bzw. 8 für den Prototypen?
        \hline
    \end{tabular}
