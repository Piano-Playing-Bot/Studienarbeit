...
Bei der Entwicklung der Widgets bleibend lässt sich hier auch der Bottom Up Ansatz evaluieren.
Zuerst ist zu bemerken, dass viele \ac{UI} Elemente mehrfach verwendet werden und somit eine Kompression derer in einzelne Funktionen oftmals vorgekommen ist.
Diese Teilung des Codes entlang der Widgets wäre dabei auch sehr wahrschenlich bei einem Top-Down Ansatz gewählt worden.
Ein Beispiel, das bei einem Top-Down Ansatz zumindest nicht offensichtlich wäre, ist die Datenstruktur eines
