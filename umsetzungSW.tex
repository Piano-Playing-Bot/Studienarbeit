...
% So wurden beispielsweise die Möglichkeiten der Kommunikation zwischen \ac{SAM} und \ac{MC} mithilfe von Prototypen gefunden.
...
% @TODO(Val): Erste Entscheidung: Raylib nutzen

% @TODO(Val): Immediate Mode vs Retained Mode UI

% @TODO(Val): IM - RM ist ein Spektrum

% @TODO(Val): Raylib API: Abstraktionslevel unter IM/RM UI
...
% @TODO(Val): Am Anfang erwähnen, dass Ergebnisse hier auch vorkommen

\section{Ergebnisse} \label{umsetzungSW-Ergebnisse}
