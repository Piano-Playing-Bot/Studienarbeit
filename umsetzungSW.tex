...
% @TODO(Val): Was wurde alles nicht umgesetzt?
% - umbenennen/löschen von Musikstücken
% - Import von PIDI Dateien
% - Import von anderen Dateitypen
% - vollständiger MIDI support

% @TODO(Val): Comm-Thread sendet Antworten auf Requests sofort (falls eine Nachricht bereits gesendet wurde, bricht das das SPPP Protokoll)
