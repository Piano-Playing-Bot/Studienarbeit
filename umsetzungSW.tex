...
Es wurde sich entschieden, die gesamte Implementierung der Software in der Programmiersprache C\footnote{Streng genommen ist hier der ISO-Standard C99 gemeint; siehe \cite{iso.c99} für die Spezifikation. Der Einfachheit halber wird in dieser Arbeit jedoch nur von \enquote{C} gesprochen.} zu erstellen.
...
\begin{figure}[htbp]
	...
	\caption{Screenshot der Startseite in der Desktop-Anwendung}
	\label{img:ui-start}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption{Screenshot der Import-Seite in der Desktop-Anwendung}
	\label{img:ui-dnd}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption{Screenshot der Umbenennung beim Import in der Desktop-Anwendung}
	\label{img:ui-rename}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption{Screenshots der Wiedergabe in der Desktop-Anwendung}
	\label{img:ui-play}
\end{figure}
...
\subsection{Kommunikation auf dem Mikrocontroller} \label{umsetzungSW-Kommunikation-MC}
