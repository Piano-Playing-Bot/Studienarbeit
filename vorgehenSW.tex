...
% @TODO(Val): Nicht-linearität von MIDI-Dateien erwähnen (i.e. zeitliche Sortierung ist nur innerhalb von Chunks festgelegt)

% @TODO(Val): Schlussfolgerung -> Eigenes Format
% @TODO(Val): Design-Decisions erläutern und abwägen (PIDI und Alternativen erklären)
